...
export async function PUT(
  ...
  try {
    ...
    const updatedUser = await prisma.pengelola.update({
...
// Optional: Handler untuk GET (melihat data pengelola sebelum update)
export async function GET(
  ...
  try {
    ...
    const user = await prisma.pengelola.findUnique({
      where: { id: Number.parseInt(id) },
      select: {
        id: true,
        name: true,
