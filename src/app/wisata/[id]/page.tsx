              ...
              <div className="mb-10">
                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
                  {[
                    ...
                    { icon: "restaurant", name: "Restoran" },
                    { icon: "toilet", name: "Toilet Umum" },
                    { icon: "shop", name: "Toko Souvenir" },
                    { icon: "guide", name: "Pemandu Wisata" },
                    { icon: "accessibility", name: "Akses Kursi Roda" },
                    { icon: "photo", name: "Spot Foto" },
                    { icon: "rest", name: "Area Istirahat" },
                  ].map((facility, index) => (
                    <div
                      key={index}
