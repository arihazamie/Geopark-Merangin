          ...
          <div className="w-full">
            <div className="relative rounded-xl overflow-hidden mb-4 aspect-[16/9]">
              ...
              {attraction.isVerified && (
                <div className="absolute flex items-center gap-1 px-3 py-1 text-sm font-medium rounded-full top-4 right-4">
                  <CheckCircle size={16} />
              ...
              <div className="p-6 shadow-sm rounded-xl">
                <div className="flex flex-col gap-6 md:flex-row">
                  ...
                  <div className="flex-1">
                    <h3 className="mb-3 text-lg font-medium">5-Day Forecast</h3>
                    <div className="grid grid-cols-5 gap-2">
                      {[
                        { day: "Mon", icon: <Sun size={20} />, temp: "29°C" },
                        { day: "Tue", icon: <Cloud size={20} />, temp: "27°C" },
                        {
                          day: "Wed",
                        ...
                        { day: "Fri", icon: <Sun size={20} />, temp: "28°C" },
                      ].map((day, index) => (
                        <div
                          key={index}
              ...
              <div className="p-6 shadow-sm rounded-xl">
                <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                  <div className="flex gap-3">
                    <div className="p-2 rounded-full text-amber-600 h-fit">
                  ...
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <ul className="mt-2 space-y-1 list-disc list-inside text-muted-foreground">
                        <li>Opening hours: 08:00 AM - 06:00 PM</li>
                        <li>Entrance fee: Adults $10, Children $5</li>
                        <li>
                          Photography is allowed (no flash in certain areas)
                        </li>
                ...
                <div className="pt-6 mt-6 border-t">
                  ...
                  <p className="text-muted-foreground">
                    This is a protected area. Please help preserve this natural
                    treasure by not littering, not removing any plants or
                    artifacts, and respecting wildlife. Your cooperation ensures
                    this destination remains beautiful for future generations.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="mb-10">
              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
                {[
                  ...
                  { icon: "toilet", name: "Public Toilets" },
                  { icon: "shop", name: "Souvenir Shop" },
                  { icon: "guide", name: "Tour Guides" },
                  { icon: "accessibility", name: "Wheelchair Access" },
                  { icon: "photo", name: "Photo Spots" },
                  { icon: "rest", name: "Rest Areas" },
                ].map((facility, index) => (
                  <div
                    key={index}
