...
import { Calendar, Landmark, Menu, FileText, User } from "lucide-react";
...
import WisataPage from "./components/adminWisata";
import ArtikelPage from "./components/adminArtikel";
import EventPage from "./components/adminEvent";
import PengelolaPage from "./components/adminPengelola";
          ...
          <SheetContent
            ...
            <nav className="grid gap-2 text-lg font-medium">
              ...
              <button
                ...
                onClick={() => handleTabChange("pengelola")}>
